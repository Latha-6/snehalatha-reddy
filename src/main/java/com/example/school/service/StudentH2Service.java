...
public class StudentH2Service implements StudentRepository {
    ...
    public Student getStudentById(int studentId) {
        try {
            ...
            throw new ResponseStstusException(HttpStatus.NOT_FOUND);
        }
    }
    ...
    @Override
    public String addMultipleStatudents(ArrayList<Student> studentsList) {
        ...
        String reponseMessage = String.format("Successfully added %d student", studentList.size());
    ...
    public Student updateStudent(int studentId, Student student) {
        if (student.getStudentName() != null) {
            db.update("update student set studentName = ? whre studentId =?", student.getStudentName(), studentId);
        }
        if (student.getGender() != null) {
            db.update("update student set Gender = ? where student =?", student.getGender(), studentId);
        }
